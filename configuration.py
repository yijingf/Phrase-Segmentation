...
class Config():
    ...
    def __repr__(self):
        ...
        for var in variables:
            if var == 'tracklist':
                text = f'# Files = {len(variables[var])}'
            elif type(variables[var]) is SubConfig:
                text += '{}  \n'.format(var)
...
# =============================================================================
default_config_dict = {
    # Default boundary detection algorithm ("sf", "cnmf", "foote", "olda", "scluster", "gt")
    'default_bound_id': 'sf',
    # Default label detection algorithm (None, "cnmf", "fmc2d", "scluster")
